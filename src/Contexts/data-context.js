...
export function DataProvider({children}) {
    let data = [
        {
            videoId: "zpROwouRo_M",
            title: "NFTs Are Fueling a Boom in Digital Art. Here’s How They Work | WSJ",
            uploadedBy: "Wall Street Journal",
            description: "Non-fungible tokens, or NFTs, have exploded onto the digital art scene this past year. Proponents say they are a way to make digital assets scarce, and therefore more valuable. WSJ explains how they work, and why skeptics question whether they’re built to last. Photo Illustration: Jacob Reynolds/WSJ",
            likes: 111,
            views: 999,
            subscribers: 42
        },
        {
            videoId: "uZ_9HXU67RY",
            title: "The NFT Bubble: Why 97% of All NFT Art Right Now Is a Bad Investment | The Outer Realm Podcast",
            uploadedBy: "GaryVee",
        ...
        },
        {
            ...
            description: "So I'm going to describe what an NFT is in the most basic terms as I can. NFT stands for Non Fungible Token.",
            likes: 111,
            views: 999,
            subscribers: 42
        },
        {
            ...
            description: "Mike Winkelmann, better known as Beeple, has sold the most expensive digital artwork in history. It’s part of an explosion in the market for NFTs — tokens that prove ownership of things like digital art that you can’t even touch.",
            likes: 111,
            views: 999,
            subscribers: 42
        },
        ...
        },
        {
            ...
            description: "So what are NFTs all about? And how can they be used in decentralized finance? You’ll find answers to these questions in this video.",
            likes: 111,
            views: 999,
            subscribers: 42
        },
        ...
        switch(type){
            ...
            case "REMOVE_FROM_PLAYLIST" : {
                ...
                return {
                    ...state, playlists : state.playlists.map(playlist => {
                        return playlist.id === payload.playlistId ?
                            {...playlist, videos: playlist.videos.filter( item => item !== payload.videoId)}
                        : 
                            playlist
                    })
                }
